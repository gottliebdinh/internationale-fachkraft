...
export const EMPLOYER_MATCH_INTRO_SEEN_KEY = "gevin_employer_match_intro_v1";

/** Einmal nach erfolgreicher Arbeitgeber-Registrierung setzen → Intro erzwingen. */
export const EMPLOYER_MATCH_INTRO_AFTER_REGISTER_KEY = "gevin_employer_force_match_intro_v1";
