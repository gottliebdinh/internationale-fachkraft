...
<head>
  ...
  <title>Lotus&Eagle – Passwort festlegen</title>
</head>
<body style="margin:0;padding:0;background-color:#f5f5f7;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;-webkit-font-smoothing:antialiased">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08)">
        ...
        <tr><td style="padding:28px 32px 24px;background-color:#1a1a2e;text-align:center">
          <a href="${siteUrl}" style="text-decoration:none">
            <span style="font-size:24px;font-weight:700;color:#ffffff;letter-spacing:0.5px">Lotus&Eagle</span>
          </a>
        </td></tr>

        <!-- Body -->
        <tr><td style="padding:36px 32px 32px">
          <h1 style="margin:0 0 8px;font-size:20px;font-weight:600;color:#1a1a2e;line-height:1.3">Willkommen bei Lotus&Eagle</h1>
          ...
          <p style="margin:0 0 16px;font-size:15px;color:#333;line-height:1.7">${company ? `Ihr Unternehmenskonto für <strong style="color:#1a1a2e">${escapeHtml(company)}</strong> auf der Lotus&Eagle-Plattform wurde angelegt.` : "Ihr Konto auf der Lotus&Eagle-Plattform wurde erfolgreich angelegt."} Um Ihren Zugang zu aktivieren, legen Sie bitte ein persönliches Passwort fest.</p>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 24px;background-color:#f8f9fa;border-radius:8px;border-left:3px solid #1a1a2e">
            <tr><td style="padding:14px 18px">
              ...
              <p style="margin:0;font-size:13px;color:#555;line-height:1.6">Nach der Passwortvergabe können Sie sich direkt anmelden und erhalten Zugang zu ausgewählten Fachkräfteprofilen auf der Lotus&Eagle-Plattform.</p>
            </td></tr>
          </table>
          ...
          <p style="margin:0;font-size:12px;color:#999;line-height:1.6">Falls Sie kein Konto bei Lotus&Eagle erstellt haben oder diese E-Mail nicht erwartet haben, können Sie sie ignorieren. Der Link ist aus Sicherheitsgründen nur begrenzt gültig.</p>
        </td></tr>

        <!-- Footer -->
        <tr><td style="padding:20px 32px;background-color:#fafafa;border-top:1px solid #eee;text-align:center">
          <p style="margin:0 0 4px;font-size:12px;color:#999;line-height:1.5">&copy; ${year} Lotus&Eagle &mdash; Internationale Fachkr&auml;fte f&uuml;r Deutschland</p>
  ...
  const { error } = await resend.emails.send({
    from,
    to: opts.to,
    subject: "Lotus&Eagle – Passwort festlegen",
    html,
  });
